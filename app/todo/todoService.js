class TodoService {
	constructor(){
		this.todoMorning = [{'description' : 'Supply Order to customer Nimal','time' : '8.00 - 9.00 AM '},
						{'description' : 'Get new orders  in Kandy','time' : '9.00-10.30 AM'},
						{'description' : 'Get Items from store','time' : '10.30-12.00 AM'},
					   ];
		this.todoAfterNoon = [{'description' : 'Get new orders in Gampola','time' : '1.00-3.30 PM'},
